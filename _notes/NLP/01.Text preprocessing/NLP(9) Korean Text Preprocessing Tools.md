...
#[('공', '들여'), ('쌓은', ''), ('탑', '도'), ('언젠가는', ''), ('무너지지.', ''), ('하지만,', ''), ('정성', '을'), ('다해', ''), ('그', ''), ('탑', '을'), ('쌓으면서', ''), ('자기', ''), ('마음', ''), ('속', '에서'), ('자란', ''), ('생각', '은'), ('절대', '로'), ('허물어지지', ''), ('않는겨.', ''), ('산다', '는'), ('건', ''), ('누구', '에겐가'), ('정성', '을'), ('쏟는', ''게지')]
```
<br><br><br>
### Max Score Tokenizer
...
print(twitter.morphs('푸우가 달려왔을 때 이요르는 생각을 잠시 멈출 수 있어서 매우 기뻤습니다'))

#['푸우', '가', '달려왔을', '때', '이요', '르', '는', '생각', '을', '잠시', '멈출', '수', '있', '어서', '매우', '기뻤습니다']

  

twitter.add_dictionary('이요르', 'Noun')

print(twitter.morphs('푸우가 달려왔을 때 이요르는 생각을 잠시 멈출 수 있어서 매우 기뻤습니다'))

#['푸우', '가', '달려왔을', '때', '이요르', '는', '생각', '을', '잠시', '멈출', '수', '있', '어서', '매우', '기뻤습니다']
```
